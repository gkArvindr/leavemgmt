...
|
*/
$config['sess_cookie_name']	= 'it-infratech_session';
...
//default email from
$config['from_mail'] = 'gkarvindr@gmail.com';
$config['from_name'] = 'it-infratech';
$config['subject_prefix'] = '[it-infratech] ';
