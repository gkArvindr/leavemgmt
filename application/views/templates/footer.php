    ...
    <div class="row" id="footer">
        ...
        <div class="span4 pull-right">
              <?php switch ($language_code){
                  case 'fr' : echo '<a class="anchor" href="http://it-infratech.in/" target="_blank">it-infratech</a>'; break;
                  default : echo '<a class="anchor" href="http://it-infratech.in/" target="_blank">it-infratech</a>'; break;
              } ?>
          &nbsp;v0.6.5&nbsp;&copy;2014-2018 IT Infratech
        </div>
    </div>
    </div>
