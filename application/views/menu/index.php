...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-19140283-4"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-19140283-4'); 
</script>
...
<div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
          <a href="<?php echo base_url();?>home" class="brand">&nbsp;<img src="<?php echo base_url();?>assets/images/brand.png" height="18" width="18" style="margin-top:-6px;">&nbsp;II Infratech </a>
            <div class="nav-responsive">
             ...
             <?php if ($is_manager == TRUE) { ?>
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li><a href="<?php echo base_url();?>requests/delegations"><?php echo lang('menu_validation_delegations');?></a></li>></li>
